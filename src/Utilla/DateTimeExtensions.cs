//-----------------------------------------------------------------------
// <copyright file="DateTimeExtensions.cs" company="Utilla">
//     Copyright © Utilla 
// </copyright>
//-----------------------------------------------------------------------
namespace Utilla
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static bool IsWithinOneSecondOf(this DateTime date, DateTime compare)
        {
            return System.Math.Abs((date - compare).TotalMilliseconds) < 1000D;
        }
    }
}
