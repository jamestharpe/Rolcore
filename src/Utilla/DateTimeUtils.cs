//-----------------------------------------------------------------------
// <copyright file="DateTimeUtils.cs" company="Utilla">
//     Copyright © Utilla 
// </copyright>
//-----------------------------------------------------------------------
namespace Utilla
{
    ...
    public class DateTimeUtils
    {
        ...
        public static DateTime[] HolidaysByYear(int year)
        {
            ...
            //Not a Utilla Holiday: result.Add(GetNthDayOfWeekInMonth(year, 1, DayOfWeek.Monday, 3));
            ...
            // Not a Utilla Holiday: result.Add(new DateTime(year, 11, 11));
