...
namespace Utilla.Web
{
    ...
    {
        const string ClientLanguageCodeKey = "Utilla.Web.HttpContextExtensionMethods.ClientLanguage";
        const string UnrewrittenUrlItemsKey = "Utilla.Web.HttpContextExtensionMethods.UnrewrittenUrl";
