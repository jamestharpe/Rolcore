using Utilla Contributors.Integration.Utils;
using Microsoft.VisualStudio.TestTools.UnitTesting;
namespace Utilla Contributors.Integration.Tests
{
    ...
    public class WebUtilsTest
    {
        ...
        public void GetUrlSubdomainTest()
        {
            ...
            Assert.AreEqual("nets", Utilla Contributors.Web.UI.WebUtils.GetUrlSubdomain("https://nets.orkin.com/pest-control/ohio-oh"));
